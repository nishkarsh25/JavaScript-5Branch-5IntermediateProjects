...
<img src="https://github.com/nishkarsh25/JavaScript-5Branch-5IntermediateProjects/blob/main/Screenshots/ss1.png" alt="Screenshot 1" width="1000"> 


# GIF's
<img src="https://github.com/nishkarsh25/JavaScript-5Branch-5IntermediateProjects/blob/main/Screenshots/ss2.gif" alt="Screenshot 4" width="1000">
...
1. **Fill out the Form**: Enter your information into the provided input fields.
2. **Validation**: As you type, the form dynamically validates each input field.
3. **Feedback**: Receive immediate feedback on input validity through error or success messages and color highlighting.
4. **Submission**: Once all inputs are valid, you can submit the form successfully.
